...
function multiplicar(){
    ...
    monto_retirar = document.getElementById("monto").value;
    if (monto_retirar<10) { 
        
        alert('El monto debe ser mayor de 10 dolares...');
        return false;} 
    else { 
        // THIS VALUES MUST BE DYNAMICS
        // LOADED FROM SOMEWHERE
        // COULD BE USEING VAR = {{DJANGO SETTINGS VALUE}} FROM MAIN VIEW
        fees_paypal = monto_retirar*0.054 + 0.3;
        document.getElementById("feespaypal").value = fees_paypal.toFixed(2);
        tipo_de_cambio = 15
        monto_recibir = [(monto_retirar-fees_paypal)*tipo_de_cambio]*0.85;
